...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "bfbcli",
		Short: "Command line interface for interacting with BFB blockchain daemon (server)",
	}

	// Add --chain-id to persistent flags and mark it required
	rootCmd.PersistentFlags().String(client.FlagChainID, "", "Chain ID of BFB node")
	...
	executor := cli.PrepareMainCmd(rootCmd, "BFB", app.DefaultCLIHome)
